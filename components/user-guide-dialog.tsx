        ...
        <div className="space-y-2">
          ...
          >
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Welcome to GSD Task Manager!</h4>
                <p className="text-sm text-foreground-muted">
                  GSD (Get Stuff Done) helps you prioritize what matters using the Eisenhower Matrix.
                  This guide will help you master productivity and achieve your goals.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-foreground mb-2">Creating Your First Task</h4>
                <ol className="text-sm text-foreground-muted space-y-2 list-decimal list-inside">
                  <li>Click the <strong>New Task</strong> button (or press <kbd className="px-2 py-1 bg-background-muted rounded text-xs">N</kbd>)</li>
                  <li>Enter a clear, actionable title (e.g., "Review Q4 budget proposal")</li>
                  <li>Add details in the description field</li>
                  <li>Categorize: Is it <strong>Urgent</strong>? Is it <strong>Important</strong>?</li>
          ...
          >
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-foreground-muted">
                  President Eisenhower said: <em>"What is important is seldom urgent, and what is urgent is seldom important."</em>
                  This matrix helps you distinguish between the two and act accordingly.
                </p>
              </div>
              ...
              <div className="rounded-lg bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900 p-3">
                <h5 className="font-semibold text-sm text-red-600 dark:text-red-400 mb-2">Common Mistake: Living in Q1</h5>
                <p className="text-sm text-red-600 dark:text-red-400">
                  Many people spend 80% of time in Q1, firefighting constantly. This leads to burnout.
                  The solution? Schedule Q2 time daily (even 30 minutes) to prevent future Q1 crises.
                </p>
              </div>
            </div>
          </GuideSection>
            ...
            <div className="space-y-4">
              ...
              >
                <ul className="text-sm text-foreground-muted space-y-1 list-disc list-inside">
                  <li><strong>Daily:</strong> Exercise, journaling, standup meetings</li>
                  <li><strong>Weekly:</strong> Review tasks, team 1-on-1s, planning</li>
                  <li><strong>Monthly:</strong> Budget review, goal check-ins, reports</li>
                  <li>When completed, a new task is auto-created with the next due date</li>
              ...
              >
                <ul className="text-sm text-foreground-muted space-y-1 list-disc list-inside">
                  <li><strong>Projects:</strong> #website-redesign, #q4-launch</li>
                  <li><strong>Contexts:</strong> #at-office, #at-home, #phone-calls</li>
                  <li><strong>Energy:</strong> #deep-work, #quick-wins, #low-energy</li>
              ...
              >
                <ul className="text-sm text-foreground-muted space-y-1 list-disc list-inside">
                  ...
                  <li>Example: "Launch product" → Research, Design, Build, Test, Deploy</li>
                </ul>
              </AdvancedFeature>
              ...
              >
                <ul className="text-sm text-foreground-muted space-y-1 list-disc list-inside">
                  ...
                  <li>Example: Can't "Deploy to production" until "QA testing" is complete</li>
                </ul>
              </AdvancedFeature>
          ...
          >
            <div className="space-y-4 text-sm">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Built-in Smart Views</h4>
                <ul className="space-y-2 text-foreground-muted">
                  <li><strong>Today's Focus:</strong> All tasks due today—your daily action list</li>
                  <li><strong>This Week:</strong> Everything due in the next 7 days</li>
                  <li><strong>Overdue Backlog:</strong> Past-due tasks requiring attention</li>
                  <li><strong>No Deadline:</strong> Tasks without due dates (good for Q2 work)</li>
                  <li><strong>Recently Added:</strong> Tasks created in the last 7 days</li>
                  <li><strong>Recently Completed:</strong> Your wins from the past week</li>
                  <li><strong>Recurring Tasks:</strong> All repeating tasks</li>
                </ul>
              </div>

              <div>
                <h4 className="font-semibold text-foreground mb-2">Creating Custom Views</h4>
                <ol className="space-y-2 text-foreground-muted list-decimal list-inside">
                  ...
                  <li>Name it descriptively (e.g., "Monday Morning Priorities")</li>
              ...
              <div className="rounded-lg bg-accent/10 border border-accent/20 p-3">
                <p className="text-foreground">
                  <strong>Workflow Idea:</strong> Create a "Deep Work Thursday" view filtering for #deep-work tasks in Q2.
                  Check this view every Thursday to protect your focus time!
                </p>
              </div>
            </div>
          </GuideSection>
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-foreground-muted mb-2">
                  Click anywhere on a task card to select it. A ring appears around selected tasks.
                  Selection mode activates automatically when you select the first task.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground-muted">
                  <li><strong>Complete:</strong> Mark multiple tasks done at once</li>
                  <li><strong>Uncomplete:</strong> Reopen completed tasks</li>
                  <li><strong>Move to Quadrant:</strong> Bulk recategorization</li>
                  <li><strong>Add Tags:</strong> Tag multiple related tasks simultaneously</li>
                  <li><strong>Delete:</strong> Remove multiple tasks (use carefully!)</li>
                </ul>
              </div>

              <div className="rounded-lg bg-accent/10 border border-accent/20 p-3">
                <p className="text-foreground">
                  <strong>Use Case:</strong> End of week? Select all completed tasks, add #done-this-week tag,
                  then review them for your weekly wins celebration!
                </p>
              </div>
            </div>
          </GuideSection>
          ...
          >
            <div className="space-y-4 text-sm">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Understanding Metrics</h4>
                <ul className="space-y-2 text-foreground-muted">
                  <li><strong>Completion Rate:</strong> Percentage of tasks completed. Aim for 70-80% (not 100%—that means you're not challenging yourself!)</li>
                  <li><strong>Streaks:</strong> Consecutive days with completions. Build momentum!</li>
                  <li><strong>Quadrant Distribution:</strong> Where is your time going? Goal: 60-70% in Q2</li>
                  <li><strong>Tag Analytics:</strong> Which projects/contexts get most attention?</li>
                  <li><strong>Trends:</strong> 7/30/90 day views show patterns over time</li>
                </ul>
              </div>

              <div>
                <h4 className="font-semibold text-foreground mb-2">Using Data for Improvement</h4>
                <div className="space-y-2 text-foreground-muted">
                  <p><strong>If Q1 is &gt;30%:</strong> You're firefighting too much. Schedule more Q2 planning time.</p>
                  <p><strong>If Q4 is &gt;10%:</strong> You're wasting time. Ruthlessly eliminate these tasks.</p>
                  <p><strong>If completion rate is &lt;50%:</strong> You're over-committing. Create fewer, more focused tasks.</p>
                  <p><strong>If streaks are inconsistent:</strong> Commit to completing at least one task daily, even small wins.</p>
                </div>
              </div>
            </div>
          </GuideSection>
          ...
          >
            <div className="space-y-4 text-sm">
              ...
              <div className="rounded-lg bg-accent/10 border border-accent/20 p-3">
                <h5 className="font-semibold text-foreground mb-2">Time Blocking Strategy</h5>
                <p className="text-foreground-muted mb-2">
                  Schedule your quadrants throughout the day:
                </p>
                <ul className="list-disc list-inside text-foreground-muted space-y-1">
                  <li><strong>8-10am:</strong> Q2 Deep Work (most creative energy)</li>
                  <li><strong>10-12pm:</strong> Q1 Urgent tasks & meetings</li>
                  <li><strong>12-1pm:</strong> Lunch & Q4 catch-up</li>
                  <li><strong>1-3pm:</strong> Q3 Delegate & communicate</li>
                  <li><strong>3-5pm:</strong> Q2 or Q1 depending on urgency</li>
                </ul>
              </div>
            </div>
          </GuideSection>
          ...
          >
            <div className="space-y-4 text-sm">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Local-First Architecture</h4>
                <p className="text-foreground-muted">
                  All your data stays on YOUR device. GSD uses IndexedDB (browser storage) to save tasks, settings, and preferences.
                  Nothing is sent to any server. No tracking, no analytics, no cloud sync. Your tasks are private by design.
                </p>
              </div>

              <div>
                <h4 className="font-semibold text-foreground mb-2">Backup Strategy</h4>
                <ul className="space-y-2 text-foreground-muted">
                  <li><strong>Weekly Exports:</strong> Settings → Export Tasks → Save JSON file</li>
                  <li><strong>Version Control:</strong> Name files with dates (e.g., gsd-backup-2025-10-12.json)</li>
                  <li><strong>Cloud Backup:</strong> Store export files in Dropbox/iCloud/Drive</li>
                  <li><strong>Before Major Changes:</strong> Always export first!</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-foreground-muted list-disc list-inside">
                  <li><strong>Merge:</strong> Add imported tasks to existing ones (safe for combining)</li>
                  <li><strong>Replace:</strong> Delete everything and start fresh (destructive!)</li>
                </ul>
              </div>

              <div className="rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-900 p-3">
                <h5 className="font-semibold text-sm text-green-600 dark:text-green-400 mb-2">Privacy Guarantee</h5>
                <p className="text-green-600 dark:text-green-400">
                  GSD Task Manager is open source and auditable. View the code on GitHub to verify:
                  zero network requests, zero tracking, zero data collection. Your productivity is your business.
                </p>
              </div>
            </div>
          </GuideSection>
          ...
          >
            <div className="space-y-4 text-sm">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Essential Shortcuts</h4>
                <div className="space-y-2">
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-2">Power User Tips</h4>
                <ul className="space-y-2 text-foreground-muted">
                  ...
                  <li>💡 Use subtasks for complex projects (keeps main list clean)</li>
                  <li>💡 Create Smart Views for morning/afternoon routines</li>
                  <li>💡 Batch similar tasks together (e.g., all #phone-calls at once)</li>
                  <li>💡 Use dependencies to sequence projects correctly</li>
                  <li>💡 Hide completed tasks during work, show them for review</li>
                </ul>
              </div>

              <div className="rounded-lg bg-accent/10 border border-accent/20 p-3">
                <p className="text-foreground">
                  <strong>Hidden Gem:</strong> Click Matrix/Dashboard toggle to quickly switch views.
                  Use Matrix for planning, Dashboard for reflection on what you accomplished!
                </p>
              </div>
            </div>
          </GuideSection>
          ...
          >
            <div className="space-y-4 text-sm">
              <div>
                <h4 className="font-semibold text-foreground mb-2">Installing as an App</h4>
                <div className="space-y-2 text-foreground-muted">
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-2">Offline Capabilities</h4>
          ...
          <div className="rounded-lg bg-gradient-to-r from-accent/10 to-accent/5 border border-accent/20 p-4 mt-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2 text-sm">
                <h4 className="font-semibold text-foreground">Remember: The Matrix is a Tool, Not a Rule</h4>
                <p className="text-foreground-muted">
                  There's no "perfect" way to use GSD. Experiment with workflows, adjust quadrants as you learn,
                  and adapt the system to your life. The goal isn't perfect categorization—it's intentional action
                  toward what matters most.
                </p>
                <p className="text-foreground-muted">
                  <strong>Start small.</strong> Master one section at a time. Even using just the basic matrix will
                  transform your productivity. The advanced features are here when you're ready.
                </p>
...
function GuideSection({ icon, title, expanded, onToggle, children }: GuideSectionProps) {
  return (
...
function QuadrantGuide({ title, color, description, examples, strategy, timeAllocation }: QuadrantGuideProps) {
  return (
    <div className="rounded-lg border border-card-border bg-background-muted/30 p-4">
      <div className="flex items-center justify-between mb-2">
        <span className={`rounded px-3 py-1 text-sm font-semibold ${color}`}>{title}</span>
        <span className="text-xs font-medium text-foreground-muted">Target: {timeAllocation}</span>
      </div>
      ...
      <div className="text-xs bg-background rounded p-2 border border-border">
        <strong className="text-accent">Strategy:</strong> <span className="text-foreground-muted">{strategy}</span>
      </div>
    </div>
  );
}
...
function AdvancedFeature({ icon, title, description, children }: AdvancedFeatureProps) {
  return (
    <div className="rounded-lg border border-card-border bg-background-muted/30 p-4">
